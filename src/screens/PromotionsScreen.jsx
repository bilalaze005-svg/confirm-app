...
/**
 * @file PromotionsScreen.jsx
 * @description يعرض للموظف (مندوب المبيعات) قائمة العروض النشطة حالياً —
 * نفس بيانات جدول promotions التي يُطبِّقها useStoreOrder.js تلقائياً على
 * فاتورة الطلبية — حتى يستطيع إخبار صاحب المحل عنها أثناء أخذ الطلبية.
 */
export default function PromotionsScreen({ onClose }) {
  ...
  return (
    <div style={{ minHeight: '100vh', background: T.bg }}>
      <div style={{ background: 'white', padding: '18px 18px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: `1px solid ${T.border}`, position: 'sticky', top: 0, zIndex: 5 }}>
        ...
        <div style={{ fontWeight: 900, fontSize: 15 }}>🎯 العروض النشطة</div>
        <div style={{ width: 20 }} />
      </div>
