...
export default function LoginScreen({ onLogin }) {
  ...
  // ── خطوة مزامنة كلمة مرور تغيّرت بالنظام القديم (نادرة) ──
  if (step === 'resync') {
    return (
      <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: 24, background: T.primaryGradient }}>
        <div style={{ background: 'white', borderRadius: 28, padding: 30, boxShadow: '0 20px 50px rgba(0,0,0,.2)' }}>
          <div style={{ textAlign: 'center', marginBottom: 22 }}>
            ...
            <h1 style={{ fontSize: 17, fontWeight: 900 }}>تحديث كلمة المرور</h1>
            <p style={{ fontSize: 12, color: T.textFaint, marginTop: 4 }}>لاحظنا تغييراً بكلمة المرور — أرسلنا كود تأكيد لبريدك (مرة واحدة فقط)</p>
          </div>
          <input
